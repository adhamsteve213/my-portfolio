...
const Contact = ({ language, translations }) => {
  ...
  const contactCategories = [
    ...
    {
      title: t.behance || 'Behance',
      icon: 'fab fa-behance',
      color: '#1769ff',
      bg: 'rgba(23, 105, 255, 0.1)',
      items: [
        { value: 'adhamsteve', link: 'https://www.behance.net/adhamsteve' },
      ]
    },
    {
...
`;
fs.writeFileSync('c:/Users/user/Desktop/portfolio-front-main (2)/portfolio-front-main/src/components/Contact.js', content, 'utf8');
console.log('Done!');
